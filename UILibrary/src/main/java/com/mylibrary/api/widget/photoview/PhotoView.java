 ...
 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either com.clscat.app or implied.
 * See the License for the specific language governing permissions and
 * limitations under the License.
 *******************************************************************************/
package com.mylibrary.api.widget.photoview;
...
public class PhotoView extends ImageView {
    ...
    /**
     * 功    能：网络加载 大量图片  id  加载前显示的预加载图片
     * 参    数：
     * 返回值：无
     **/
    public void setImgURL(String url, int id) {
