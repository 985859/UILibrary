...
public class PicassoDrawable extends Drawable {

  public static final String TAG = "PicassoDrawable";
  ...
  private final RectF mBorderRect = new RectF();//边线的位置
  ...
  public PicassoDrawable(Bitmap bitmap) {
    mBitmap = bitmap;
  ...
  public static PicassoDrawable fromBitmap(Bitmap bitmap) {
    if (bitmap != null) {
      return new PicassoDrawable(bitmap);
    } else {
      return null;
    }
  }
  ...
  public static Drawable fromDrawable(Drawable drawable) {
    if (drawable != null) {
      if (drawable instanceof PicassoDrawable) {
        // just return if it's already a PicassoDrawable
        return drawable;
   ...
   * @return the {@link PicassoDrawable} for chaining.
   */
  public PicassoDrawable setCornerRadius(float radius) {
   ...
   * @return the {@link PicassoDrawable} for chaining.
   */
  public PicassoDrawable setCornerRadius(@Corner int corner, float radius) {
   ...
   * @return the {@link PicassoDrawable} for chaining.
   */
  public PicassoDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                         float bottomLeft) {
  ...
  public PicassoDrawable setBorderWidth(float width) {
    mBorderWidth = width;
    mBorderPaint.setStrokeWidth(mBorderWidth);
    return this;
  }
  ...
  public PicassoDrawable setBorderColor(@ColorInt int color) {
  ...
  public PicassoDrawable setBorderColor(ColorStateList colors) {
  ...
  public PicassoDrawable setOval(boolean oval) {
    mOval = oval;
    return this;
  }
  ...
  public PicassoDrawable setScaleType(ScaleType scaleType) {
    if (scaleType == null) {
  ...
  public PicassoDrawable setTileModeX(Shader.TileMode tileModeX) {
  ...
  public PicassoDrawable setTileModeY(Shader.TileMode tileModeY) {
